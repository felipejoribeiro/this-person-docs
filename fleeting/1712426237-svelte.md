...
And you can access the props in the parent component by using the `$$props` sign before the prop name. And even unamed props can be accessed by using the `$$restProps` variable.
